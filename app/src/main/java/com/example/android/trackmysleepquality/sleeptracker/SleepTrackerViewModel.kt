...
class SleepTrackerViewModel(
        ...
        val tonight: LiveData<SleepNight?>
                get() = _tonight
        val startActive = Transformations.map(tonight) {
                it == null
        }
        ...
        val clearActive = Transformations.map(nights) {
                it.isNotEmpty()
        }

        private val _navitgateToSleepQuality = MutableLiveData<SleepNight>()
        val navigateToSleepQuality: LiveData<SleepNight>
                get() = _navitgateToSleepQuality
        ...
        fun onStopTracking() {
                viewModelScope.launch {
                        ...
                        _navitgateToSleepQuality.value = oldNight
                        _tonight.value = null
                }
        }
        ...
        fun doneNavigating() {
                _navitgateToSleepQuality.value = null
        }
}
