...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //creo la aplicacion y el DAO. Con ellos creamos el ViewModel.
        ...
        //binding entre XML y viewModel
        binding.viewModel = viewModel
        binding.lifecycleOwner = viewLifecycleOwner

        viewModel.navigateToSleepQuality.observe(viewLifecycleOwner, Observer { oldNight ->
            oldNight?.let { night ->
